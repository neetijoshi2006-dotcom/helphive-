  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === 'primary' && 'bg-gradient-to-r from-primary to-primary-400 text-neutral-900 hover:shadow-lg hover:shadow-primary/30 hover:-translate-y-0.5 active:scale-95',
